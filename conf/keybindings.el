...
(defun fix-function-keys ()
  ...
  (define-key local-function-key-map "\e[1;2P" [S-f1])
  (define-key local-function-key-map "\eO2Q" [S-f2])
  (define-key local-function-key-map "\e[1;2Q" [S-f2])
  (define-key local-function-key-map "\eO2R" [S-f3])
  (define-key local-function-key-map "\e[1;2R" [S-f3])
  (define-key local-function-key-map "\eO2S" [S-f4])
  (define-key local-function-key-map "\e[1;2S" [S-f4])
  (define-key local-function-key-map "\e[15;2~" [S-f5])
  (define-key local-function-key-map "\e[31~" [S-f5])
  (define-key local-function-key-map "\e[17;2~" [S-f6])
  (define-key local-function-key-map "\e[32~" [S-f6])
  (define-key local-function-key-map "\e[18;2~" [S-f7])
  (define-key local-function-key-map "\e[33~" [S-f7])
  (define-key local-function-key-map "\e[19;2~" [S-f8])
  (define-key local-function-key-map "\e[34~" [S-f8])
  ...
  (define-key local-function-key-map "\e[14;6~" [C-S-f3])
  ...
  (define-key local-function-key-map "\e[24;6~" [C-S-f12])
  (define-key local-function-key-map "\e[1;3P" [M-f1])
  (define-key local-function-key-map "\e[1;3Q" [M-f2])
  (define-key local-function-key-map "\e[1;3R" [M-f3])
  (define-key local-function-key-map "\e[1;3S" [M-f4])
  (define-key local-function-key-map "\e[15~" [M-f5])
  (define-key local-function-key-map "\e[17~" [M-f6])
  (define-key local-function-key-map "\e[18~" [M-f7])
  (define-key local-function-key-map "\e[19~" [M-f8])
  (define-key local-function-key-map "\e[20~" [M-f9])
  (define-key local-function-key-map "\e[21~" [M-f10])
  (define-key local-function-key-map "\e[23~" [M-f11])
  (define-key local-function-key-map "\e[24~" [M-f12])
  (define-key local-function-key-map "\e[1;4P" [M-S-f1])
  (define-key local-function-key-map "\e[1;4Q" [M-S-f2])
  (define-key local-function-key-map "\e[1;4R" [M-S-f3])
  (define-key local-function-key-map "\e[1;4S" [M-S-f4])
  (define-key local-function-key-map "\e[15~" [M-S-f5])
  (define-key local-function-key-map "\e[17~" [M-S-f6])
  (define-key local-function-key-map "\e[18~" [M-S-f7])
  (define-key local-function-key-map "\e[19~" [M-S-f8])
  (define-key local-function-key-map "\e[20~" [M-S-f9])
  (define-key local-function-key-map "\e[21~" [M-S-f10])
  (define-key local-function-key-map "\e[23~" [M-S-f11])
  (define-key local-function-key-map "\e[24~" [M-S-f12]))
...
(defadvice terminal-init-xterm (after fix-function-keys activate)
  (fix-arrow-keys)
  (fix-function-keys)
  (custom-key-sequences))
