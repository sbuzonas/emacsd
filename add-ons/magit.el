(defcustom addon-magit
  nil
  "Enable magit features"
  :type 'boolean
  :group 'features)
...
(after magit
  ...
  (set-face-background 'diff-context "#666666")
  (set-face-background 'diff-added "#00cc33")
  (set-face-background 'diff-removed "#ff0000")
